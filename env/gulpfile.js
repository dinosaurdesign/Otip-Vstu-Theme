...
//переменные путей
var dir = '../wp-content/themes/otip_theme',
    path = {
        src: {
            css: dir + '/css/',
            sass: dir + '/sass/**/*.*',
...
gulp.task('browsersync', function () {
    browsersync({
        ...
        proxy: "http://otip.loc", // проксирование вашего удаленного сервера, не важно на чем back-end
...
gulp.task('scripts', function () {
    gulp.src(path.src.js)
        ...
        .pipe(concat('all.js'))
        .pipe(sourcemaps.write('.'))
        .pipe(gulp.dest(path.src.libsjs)); // Выгружаем в папку app/js
});
